...
return [
    ...
    'attributes'           => [
        ...
        'national_card_no' => 'رقم الهوية القومية',
        ...
        'floor_no' => 'الدور',
        'apartment_id' => 'الشقة',
        'apartments_on_floor' => 'عدد الشقق في الدور الواحد',
        ...
        'discount' => 'الخصم',
        'note.en' => 'الملاحظة باللغة الإنجليزية',
        'note.ar' => 'الملاحظة باللغة العربية',
        'due_category_id' => 'فئة المستحق',

        'code' => 'الكود',

        'pagination_count' => 'ترقيم الصفحات',

        'currency_name_en' => 'اسم العملة باللغة الإنجليزية',
        'currency_symbol_en' => 'علامة العملة باللغة الإنجليزية',
        'currency_name_ar' => 'اسم العملة باللغة العربية',
        'currency_symbol_ar' => 'علامة العملة باللغة العربية',
    ],
];