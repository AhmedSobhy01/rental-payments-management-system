                ...
                <div class="flex flex-col items-start w-full max-h-screen">
                    ...
                    <div class="body px-7 pt-3 pb-7  overflow-y-auto w-full text-gray-600" x-data="{showPwd: false}">
                        <div class="flex flex-col mb-4">
                            <label for="name_en" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">{{ __('app.English Name') }}</label>
                        ...
                        <div class="flex flex-col mb-4">
                            <label for="name_ar" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">{{ __('app.Arabic Name') }}</label>
                        ...
                        <div class="flex flex-col mb-4">
                            <label for="email" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">{{ __('app.Email Address') }}</label>
                        ...
                        <div class="flex flex-col mb-4">
                            <label for="password" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">{{ __('app.Password') }}</label>
                            <div class="relative">
                                <input id="password" class="border border-gray-300 p-2 outline-none w-full mt-2 rounded-md" :type="showPwd ? 'text' : 'password'" wire:model.defer="password" placeholder="{{ __('app.Leave Blank For No Change') }}">
                        ...
                        <div class="flex flex-col mb-4">
                            <label for="password_confirmation" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">{{ __('app.Confirm Password') }}</label>
                        ...
                        <div class="border-t border-gray-200">
                            <button class="text-sm mt-4 uppercase px-8 py-2 rounded bg-indigo-500 text-blue-50 w-full shadow-sm hover:shadow-lg transition-all duration-200" wire:click="updateUser" wire:loading.attr="disabled" wire:loading.class="bg-opacity-50" id="submit">{{ __('app.Save') }}</button>
                        </div>
                    </div>
                </div>
            </div>
