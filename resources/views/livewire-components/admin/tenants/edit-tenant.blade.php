            ...
            <div class="relative sm:w-3/4 md:w-2/3 lg:w-1/2 mx-2 sm:mx-auto my-10 opacity-100 bg-white" @mousedown.away="@this.call('closeModal')">
                <div class="flex flex-col items-start w-full">
                    ...
                    <div class="body px-7 pt-3 pb-7 overflow-hidden w-full">
                        ...
                        <div class="flex flex-col mb-4">
                            <label for="nationality_id" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">
                                {{ __('app.Nationality') }}
                                <span class="text-red-600 ml-1 font-bold">*</span>
                            </label>
                        ...
                        <div class="border-t border-gray-200">
                            <button class="text-sm mt-4 uppercase px-8 py-2 rounded bg-indigo-500 text-blue-50 w-full shadow-sm hover:shadow-lg transition-all duration-200" wire:click="updateTenant" wire:loading.attr="disabled" wire:loading.class="bg-opacity-50" x-ref="submit">{{ __('app.Save') }}</button>
                        </div>
                    </div>
                </div>
            </div>
